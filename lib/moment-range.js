//TODO: Terminar tests en intersect(), overlap(), subtract(), add(), _byString(), by()
...
DateRange.prototype.intersect = function(other, exclusive) {
  ...
  if ((start <= other.start) && (other.start < end || (other.start.isSame(end) && !exclusive)) && (end < other.end)) {
    return new DateRange(other.start, end);
  }
  else if ((other.start < start) && (start < other.end || (start.isSame(other.end) && !exclusive)) && (other.end <= end)) {
