...
(function() {
  ...
  makeMomentRange = function(moment) {
    /**
  ...
  if ((typeof module !== "undefined" && module !== null) && (module.exports != null)) {
    module.exports = makeMomentRange(require("moment"));
  }

  if (typeof define === "function") {
    define("moment-range", ["moment"], function(moment) {
      return makeMomentRange(moment);
    });
  }

  if (this.moment != null) {
    this.moment = makeMomentRange(this.moment);
  }
