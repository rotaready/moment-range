...
describe('Moment', function() {
  ...
  describe('#range()', function() {
    ...
    it('should support string unit `isoWeek`', function() {
      dr = m1.range('isoWeek');
      expect(dr.start.valueOf()).to.equal(moment(m1).startOf('isoWeek').valueOf());
      expect(dr.end.valueOf()).to.equal(moment(m1).endOf('isoWeek').valueOf());
    });
  });
