...
# Export
module.exports = makeMomentRange(require "moment") if module? && module.exports?

if typeof(define) == "function"
  define "moment-range", ["moment"], (moment) -> makeMomentRange(moment)

@moment = makeMomentRange(@moment) if @moment?